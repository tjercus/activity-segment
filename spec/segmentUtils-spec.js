...
test("makeSegmentsTotal should return an object with zeros when there is no data", (assert) => {
  let total = makeSegmentsTotal([]);
...
test("makeSegmentsTotal should calculate complete data on one segment without pace", (assert) => {
  let segment = {
    distance: 16,
    duration: "01:10:23"
  };
  let total = makeSegmentsTotal([segment]);
...
test("makeSegmentsTotal should return an object with complete data on two segments", (assert) => {
  let segments = [{
    distance: 16,
    duration: "01:10:23"
  }, {
  ...
  let total = makeSegmentsTotal(segments);
...
test("makeSegmentsTotal with three digit decimal precision distances should return an object with complete data with on two segments", (assert) => {
  let segments = [{
    distance: 1.08,
    duration: "00:07:43"
  }, {
...
/*
test("makeSegmentsTotal should return an object with complete data when one segment is empty", (assert) => {
  let segments = [{
    distance: 16,
    duration: "01:10:23"
  }, {
...
test("makeSegmentsTotal should return an object with complete data on one segment with missing duration", (assert) => {
  let segments = [{
    distance: 12.930,
    pace: "05:10"
  }];
...
test("makeSegmentsTotal should return an object with complete data on two segments with missing duration", (assert) => {
  let segments = [{
    distance: 12.930,
    pace: "04:10"
  }, {
...
test("makeSegmentsTotal with two segments with mixed missing data should return an object with complete data", (assert) => {
  let segments = [{
    distance: 12.930,
    pace: "04:10"
  }, {
...
test("makeSegmentsTotal with a zero'd segment should return an object with complete data", (assert) => {
  let segments = [{
    distance: 0,
    duration: "00:00:00",
    pace: "00:00"
